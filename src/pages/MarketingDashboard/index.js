              ...
              <div className="sales_section">
                <div className="main_sales">
                  <div className="sales_headings">
                    <div>
                      <p className="sub_heading">Save Products</p>
                    </div>
                    <div>
            ...
            <div className="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-3 mt-3">
              <div className="sales_section">
                <div className="main_sales">
                  <div className="sales_headings">
                    <div>
                      <p className="sub_heading">Stock Products</p>
                    </div>
                    <div>
                      <img
            ...
            <div className="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-3 mt-3">
              <div className="sales_section">
                <div className="main_sales">
                  <div className="sales_headings">
                    <div>
                      <p className="sub_heading">Sales Products</p>
                    </div>
                    <div>
                      <img
                  ...
                  <td className="table_dats">
                    <div className="action_icons">
                      <span className="edit_icon mr-0">
                        <i class="material-icons delete" title="Refresh">
                          {" "}
                          refresh
                        </i>
                      </span>
