...
const AddEdit = ({ dynamicPricingId, isCopy = false, productData, dType = '', result }) => {
    ...
    const handleSubmit = (e,override='no') => {
        ...
        // console.log("form.notApplicableFor",form.notApplicableFor)
        ...
        let value = {
            ...form, type: 'earlyBirdCustomDates',
             blackOutDates: date,
             override,
             donotDates:dates,
    ...
    return <>
        <form onSubmit={handleSubmit}>
            <div className="pprofile1">
                <h3 className="ViewUser mb-3">{form && form.id && !getCopy() ? 'Edit' : 'Add'} Early Bird Pricing Custom Dates </h3>
                <div className="form-row">
                    ...
                    <div className="col-md-6 mb-3">
                        ...
                        <span className="d-flex">
                            ...
                            <input
                                type="text"
                                className="form-control pCls w-25 ml-3"
                                placeholder="50%"
                                minLength={1}
                                maxLength={10}
                                value={form.notApply}
                        ...
                        <>
                            ...
                            <div className="col-md-12 mb-3">
                                ...
                                {availablity.length ? <>
                                    ...
                                    <div className="text-danger">Slots are not available from {datepipeModel.date(form.changesDate)} to {datepipeModel.date(form.changesDateTo)}</div>
                                </>}
