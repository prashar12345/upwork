          ...
          <div className="sales_section">
            <div className="main_sales">
              <div className="sales_headings">
                <div>
                  <p className="sub_heading">Reviews Received</p>
                </div>
                <div>
        ...
        <div className="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-3 mt-3">
          <div className="sales_section">
            <div className="main_sales">
              <div className="sales_headings">
                <div>
                  <p className="sub_heading">Average Ratings</p>
                </div>
                <div>
                  {/* <img
              ...
              <div className="sales_icons d-flex">
                <div className='flexStars mr-auto'>
                ...
                <h3 className="Amount_sales">4.1</h3>
              </div>
            </div>
          </div>
        </div>
        <div className="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-3 mt-3">
          <div className="sales_section">
            <div className="main_sales">
              <div className="sales_headings">
                <div>
                  <p className="sub_heading">Total Reviews</p>
                </div>
                <div>
                  {/* <img
        ...
        <div className="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-3 mt-3">
          <div className="sales_section">
            <div className="main_sales">
              <div className="sales_headings">
                <div>
                  <p className="sub_heading">Net Promoter Score</p>
                </div>
                <div>
              ...
              <div className="sales_icons">
                <h3 className="Amount_sales">96</h3>
              </div>
            </div>
          </div>
        </div>
